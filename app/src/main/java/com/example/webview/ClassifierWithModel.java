...
import static org.tensorflow.lite.support.image.ops.ResizeOp.ResizeMethod.BILINEAR;
...
public class ClassifierWithModel {
    private static final String MODEL_NAME = "test2model.tflite";
...
//        labels.remove(0);
    ...
    private TensorImage loadImage(final Bitmap bitmap, int sensorOrientation) {
        ...
        ImageProcessor imageProcessor = new ImageProcessor.Builder()
                ...
                .add(new ResizeOp(modelInputWidth, modelInputHeight, BILINEAR))
    ...
    public List<Pair<String, Float>> classify(Bitmap image, int sensorOrientation) {
        ...
        Collections.sort(results,(a, b)->Float.compare(b.second,a.second));

        return results;
    }

    public List<Pair<String, Float>>classify(Bitmap image) {
